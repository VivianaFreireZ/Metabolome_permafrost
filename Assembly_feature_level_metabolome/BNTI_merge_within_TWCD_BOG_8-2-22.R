...
files = list.files(path = paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/BNTI_feature_TWCD_8-2-22/Feature_bog/Habitat-Bog/"),
...
setwd("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/BNTI_feature_TWCD_8-2-22/Feature_bog/")
...
write.csv(feat.samp.frame_mol, "bog_feature_TWCD_mol_8-2-22.csv")
...
feat.melt_mol  <- left_join(feat.melt, mol, by = 'Var1') %>% 
  left_join(meta_bog, by = c('Var2' = 'SampleID'))

write.csv(feat.melt_mol, "bog_most_variable_MCD_8-2-22.csv")
...
ggsave("bog_most_variable_MOLFORM_plot_8-2-22.png", plot)
...
ggsave("bog_most_variable_CLASS_plot_8-2-22.png", plot)
...
ggsave("bog_most_variable_ELMENTAL_plot_8-2-22.png", plot)
