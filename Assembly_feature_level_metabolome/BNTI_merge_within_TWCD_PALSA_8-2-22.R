...
require(ggtree)
require(ggplot2)
require(reshape2)# For plotting the results
library(tidyverse)
...
files = list.files(path = paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/BNTI_feature_TWCD_8-2-22/Feature_palsa/Habitat-Palsa/"),
...
setwd("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/BNTI_feature_TWCD_8-2-22/Feature_palsa/")
...
write.csv(feat.samp.frame_mol, "Palsa_feature_TWCD_mol_8-2-22.csv")
...
feat.melt_mol  <- left_join(feat.melt, mol, by = 'Var1') %>% 
  left_join(meta_palsa, by = c('Var2' = 'SampleID'))

write.csv(feat.melt_mol, "Palsa_most_variable_TWCD_8-2-22.csv")
...
ggsave("Palsa_most_variable_MOLFORM_plot_8-2-22.png", plot)
...
ggsave("Palsa_most_variable_CLASS_plot_8-2-22.png", plot)
...
ggsave("Palsa_most_variable_ELMENTAL_plot_8-2-22.png", plot)
