...
for(rep in range){
  ...
  if(!dir.exists(paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/BNTI_feature_TWCD_8-2-22/Feature_fen/", "/"))){
    dir.create(paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/BNTI_feature_TWCD_8-2-22/Feature_fen/", "/"))
  }
  
  if(!dir.exists(paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/BNTI_feature_TWCD_8-2-22/Feature_fen/", "/", Factor, "-", Level))){
    dir.create(paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/BNTI_feature_TWCD_8-2-22/Feature_fen/", "/", Factor, "-", Level))
  }
  
  write.csv(null.by.samp, paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/BNTI_feature_TWCD_8-2-22/Feature_fen/", "/", Factor, "-", Level, "/", 
