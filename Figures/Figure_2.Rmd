...
```{r}
gas_cor_files <- list.files(path = 'output/',
...
```{r}
env_cor_files <- list.files(path = 'output/',
...
```{r}
micro_bnti_files <- list.files(path = 'input',
...
```{r}
bnti_counts_files <- list.files(path = 'output/',
...
ggsave('figures/Figure_2.png', figure_2, dpi = 300, width = 20, height = 12)
```
