...
ggsave('output/Supplementary_fig_2_filtered.png', supp2, dpi = 300, height = 6, width = 10)
```
...
metaT_annot_cazy <- metaT_path_cazy %>% 
  ...
  mutate(cazy_fam = case_when(
    ...
    str_detect(cazy_id, 'AA') ~ 'Auxiliary\nActivities',
...
ggsave('output/Supplementary_fig_3_filtered.png', final, dpi = 300, height = 14, width = 20)
