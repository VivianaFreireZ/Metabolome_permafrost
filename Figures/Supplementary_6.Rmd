...
```{r}
## Loading metaT processed tables

metaT_genomes <- read_tsv("../input/Emerge_metaTs_processed_v7/metaT_genomes.tsv")

metaT_path <- read_tsv("../input/Emerge_metaTs_processed_v7/metaT_pathways.tsv")

## Loading expression 

metaT_path_ex <- read_csv("../input/Emerge_metaTs_processed_v7/metaT_pathway_exp.csv")
```
...
all_plot <- pathway_all %>% 
  ...
  scale_fill_distiller(palette = 'YlOrRd', direction = 1,
                       ...
                       breaks = c(c(0.1, 1, 10, 100, 1000, 10000))) +
  labs(fill = 'TPM') +
  theme_bw() +
...
ggsave('output/Supplementary_fig_6.png', all_plot, dpi = 300, height = 10, width = 15)
```
