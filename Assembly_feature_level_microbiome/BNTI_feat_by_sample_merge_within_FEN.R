...
Sample_Name = "bNTI_Feat_microbe_bulk_fen" # Input sample name
Factor = "Habitat"
Level = "Fen"
...
files = list.files(path = paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/Paper_figures_2022/input/microbes/Feature_fen/Habitat-fen/"),
...
write.csv(feat.samp.frame_tax, "output/fen_feature_microbe_tax_3-22-22.csv")
