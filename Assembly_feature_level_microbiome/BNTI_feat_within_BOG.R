...
Sample_Name = "bNTI_feat_microbe_within_bog" # Input sample name
Factor = "Habitat"
Level = "Bog"
...
for(rep in range){
  ...
  if(!dir.exists(paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/Paper_figures_2022/input/microbes/Feature_bog", "/"))){
    dir.create(paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/Paper_figures_2022/input/microbes/Feature_bog", "/"))
  }
  
  if(!dir.exists(paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/Paper_figures_2022/input/microbes/Feature_bog", "/", Factor, "-", Level))){
    dir.create(paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/Paper_figures_2022/input/microbes/Feature_bog", "/", Factor, "-", Level))
  }
  
  write.csv(null.by.samp, paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/Paper_figures_2022/input/microbes/Feature_bog", "/", Factor, "-", Level, "/", 
