...
Sample_Name = "bNTI_Feat_microbe_bulk_palsa" # Input sample name
Factor = "Habitat"
Level = "Palsa"
...
files = list.files(path = paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/Paper_figures_2022/input/microbes/Feature_palsa/Habitat-Palsa/"),
...
write.csv(feat.samp.frame_tax, "output/Palsa_feature_microbe_tax_3-22-22.csv")