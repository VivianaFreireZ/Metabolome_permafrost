...
Sample_Name = "bNTI_feat_microbe_within_palsa" # Input sample name
Factor = "Habitat"
Level = "Palsa"
...
for(rep in range){
  ...
  if(!dir.exists(paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/Paper_figures_2022/input/microbes/Feature_palsa", "/"))){
    dir.create(paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/Paper_figures_2022/input/microbes/Feature_palsa", "/"))
  }
  
  if(!dir.exists(paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/Paper_figures_2022/input/microbes/Feature_palsa", "/", Factor, "-", Level))){
    dir.create(paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/Paper_figures_2022/input/microbes/Feature_palsa", "/", Factor, "-", Level))
  }
  
  write.csv(null.by.samp, paste0("/home/u1/vfreirezapata/ondemand/data/Meta-Metabolome_Ecology/Paper_figures_2022/input/microbes/Feature_palsa", "/", Factor, "-", Level, "/", 
